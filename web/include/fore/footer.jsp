...
<div id="footer" class="footer" style="display: block;">
    ...
    <div id="copyright" class="copyright">
        <div style="width:1024px;margin:0px auto;text-align:left;position:relative;">
            <img id="cateye" class="cateye" src="${pageContext.request.contextPath}/img/site/cateye.png" style="margin-left: 20px;display:block;position:absolute;top:-33px;left:-15px;">
